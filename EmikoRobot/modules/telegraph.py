    ...
    if event.reply_to_msg_id:
        ...
        if input_str == "gm":
            ...
            try:
                ...
                os.remove(downloaded_file_name)
                await h.edit("Uploaded to https://graph.org{}".format(media_urls[0], (ms + ms_two)), link_preview=True)
        elif input_str == "gt":
            ...
            ms = (end - start).seconds
            await event.reply("Pasted to https://graph.org{}".format(response["path"], ms), link_preview=True)
    else:
